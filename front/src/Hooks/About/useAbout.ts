...
export function useAbout() {
    const services = [
        ...
        },
        {
            ...
            text: "Разработка Android приложений на React Native",
            icon: Smartphone,
        },
        {
            title: "Скрипты и деплои",
            text: "Перенос существующих проектов на новые сервера, а также написание разовых скриптов или регулярных запуск их по крону.",
            icon: Sparkles,
        },
    ];
